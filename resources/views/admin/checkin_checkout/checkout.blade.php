...
{{-- Page title --}}
@section('title')
@lang('checkin_checkout/title.checkout_list') 
@parent
@stop
        ...
        <table border="0">
            <tr>
                <td class="p-l-40 p-t-20" align="left">
                    ...
                    <a class="fs-20" style="color: #7b7e82;">/</a>
                    <a class="active fs-20" style="color: #7b7e82;">@lang('checkin_checkout/title.checkout')</a>
                </td>
            </tr>
        </table>
                        ...
                        <table border="0">
                            <tr>
                                <td align="left" class="fs-26">
                                   <b>@lang('checkin_checkout/title.checkout_list') : </b><b style="color: #369DE2;">{{ $event->event_name }}</b>
                                </td>
                            </tr>
                        </table>
                    </div>
    ...
    <script>
        $(function() {   
            var table = $('#table').DataTable({
                ...
                ajax: {
                    'type': 'POST',
                    'url': '{!! route('admin.checkin_checkout.post_checkout_data') !!}',
                    'data': {
                ...
                $.ajax({
                    ...
                    success: function(response){
                        ...
                        if(json_data.status == "1"){
                            ...
                            if(json_data.message == 'Already Checkout.'){
                                Swal.fire({
                                    type: 'info',
                                    title: '<p class="fs-25" style="font-family: \'Kanit\', sans-serif;">'+json_data.message+'</p>',
                            ...
                            else if(json_data.message == 'Checkout Early.'){
                                Swal.fire({
                                    title: 'การ CHECK-OUT',
                                    html: 'ระบุเหตุผลในการ <b><font color="blue">กลับก่อนเวลา</font></b>',
                                    input: 'text',
                                    inputAttributes: {
                                        autocapitalize: 'off'
                                    },
