    ...
    <div class="row">
        <table border="0">
            <tr>
                ...
                <td class="p-t-20">
                    <a class="active fs-20" style="color: #7b7e82;">@lang('events/title.add_event') </a>
                </td>
            </tr>
        </table>
        <div class="col-md-12 col-sm-12 col-lg-12 my-3" style="margin-left: 25px; padding-right: 70px;">
            <div class="card panel-primary">
                ...
                <div class="card-body">
                        ...
                        <table border="0" class="col-sm-12">
                            <tr>
                                <td align="left" class="fs-26">
                                    <b>@lang('events/title.add_event')</b>
                                </td>
                                <td align="right">
                                    <button type="submit" class="btn btn-lg button-blue" id="add_event">
                    ...
                    <!--main content-->
                    <form id="commentForm" action="{{ route('admin.events.store') }}" method="POST"
                            ...
                            <div class="col-sm-7">
                                <div class="form-group {{ $errors->first('event_name', 'has-error') }}">
                                    ...
                                    <input id="event_name" name="event_name" type="text"
                                        placeholder="กรอกชื่องานอีเว้นท์" class="form-control required"
                            ...
                            <div class="col-sm-7">
                                <div class="form-group {{ $errors->first('event_location', 'has-error') }}">
                                    ...
                                    <input id="event_location" name="event_location" type="text"
                                        placeholder="กรอกชื่อสถานที่ตั้ง เช่น IMPACT Challenger 1-3"
                                        class="form-control" value="{!! old('event_location') !!}" />
                            ...
                            <div class="col-sm-5">
                                <div class="form-group {{ $errors->first('event_daterange', 'has-error') }}">
                                    ...
                                    <input id="event_daterange" name="event_daterange"
                                        placeholder="วัน/เดือน/ปี - วัน/เดือน/ปี เช่น 01/12/2562 - 07/12/2562"
                                        type="text" class="form-control daterange-input required"
                                        value="{!! old('event_daterange') !!}" />
...
<!--
    ...
    -->
<script src="{{ asset('assets/js/pages/addevent.js') }}"></script>
@stop