...
//Table Data to index page
    public function data()
    {
        ...
        return DataTables::of($news)
            ->editColumn('created_at', function (News $createtime) {
                return $createtime->created_at->diffForHumans();
            })
            ->addColumn('actions', function ($user) {
                $actions = '<a href=' . route('admin.news.show', $user->id) . '><i class="livicon" data-name="info" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="view News"></i></a>
                            <a href=' . route('admin.news.edit', $user->id) . '><i class="livicon" data-name="edit" data-size="18" data-loop="true" data-c="#428BCA" data-hc="#428BCA" title="update News"></i></a>';
                $actions .= '<a href=' . route('admin.news.confirm-delete', $user->id) . ' data-toggle="modal" data-target="#delete_confirm"><i class="livicon" data-name="trash" data-size="18" data-loop="true" data-c="#f56954" data-hc="#f56954" title="delete News"></i></a>';
    ...
    public function test()
    {
        ...
        //$employee = DB::connection('mysql2')->table('employee')->where('emp_status', 1)->get();

        $employee = DB::connection('mysql2')->table('employee')->where('emp_email', 'p@hotmail.com')->get();
